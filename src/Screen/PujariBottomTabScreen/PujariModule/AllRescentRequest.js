...
const PendingRequests = () =>
    <View style={{ flex: 1, marginBottom: hp('10%'), padding: hp('2%') }}>
            <RecentRequest showButtons={true} />
    </View>
const ApprovedRequests = () =>
    <View style={{ flex: 1, marginBottom: hp('10%'), padding: hp('2%') }}>
            <RecentRequest showButtons={false} />
    </View>

const AllRescentRequest = ({ navigation }) => {
    return (
        <View style={styles.Container}>
            ...
            <View style={styles.heading}>
                ...
                <Text style={styles.headText}>Requests</Text>
            </View>
...
export default AllRescentRequest;
