...
const ProfessionalScreen = () => {
  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.inputText}>Services</Text>
      <TextInput
        placeholderTextColor='#888'
        placeholder="Numerology, tarot reading"
        style={styles.input}
      />
      <TimeDropdown
        label="Numerology"
...
const AdvancedScreen = () => {
  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.inputText}>Add Service</Text>
      <MultipleSelectList
        setSelected={(val) => {
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={styles.profileContainer}>
        ...
        <Icon name="camera" size={hp(3.5)} color="#94CAF4" style={styles.cameraIcon} />
      </View>
