            ...
            <SafeAreaView style={styles.container}>
                ...
                <View style={styles.buttonContainer}>
                    <TouchableOpacity style={styles.chatButton}>
                        <Fontisto name="comment" size={20} color="#fff" />
                        <Text style={styles.buttonText}>Last Chat</Text>
                    </TouchableOpacity>
...
const styles = StyleSheet.create({
    ...
    Videocamera: {
        flexDirection: 'row',
        marginBottom: hp('2%'), // Reduced margin to avoid too much space
        alignItems: 'center',
        justifyContent: 'space-between',
    ...
    reviewHeader: {
        flexDirection: 'row',
        alignItems: 'center',
        marginBottom: hp('1%'), // Space between the image and review text
    },
    buttonContainer: {
        flexDirection: 'row',
        padding: hp('5%'),
    ...
    chatButton: {
        flexDirection: 'row',
        alignItems: 'center',
        backgroundColor: '#4CAF50', // Green color for chat button
        paddingVertical: hp('1%'),
        paddingHorizontal: wp('4%'),
        borderRadius: wp('2%'),
    },
    ...
    callButton: {
        flexDirection: 'row',
        alignItems: 'center',
        backgroundColor: '#2196F3', // Blue color for call button
        paddingVertical: hp('1%'),
        paddingHorizontal: wp('4%'),
        borderRadius: wp('2%'),
    },
