      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.dateContainer}>
          ...
          <TouchableOpacity onPress={() => setIsCalendarVisible(!isCalendarVisible)}>
            <AntDesign name="calendar" size={24} color="#460203" />
          </TouchableOpacity>
        </View>
        <Text style={styles.zodiacName}>Sagittarius</Text>
        <Text style={styles.horoscopeText}>{horoscopes[currentIndex].text}</Text>
        {isCalendarVisible && (
          <View style={styles.calendarDropdown}>
            <View style={styles.calendarHeader}>
              <TouchableOpacity onPress={() => setIsCalendarVisible(false)}>
                <AntDesign name="closecircle" size={24} color="#460203" />
              </TouchableOpacity>
            </View>
            <CalendarPicker
